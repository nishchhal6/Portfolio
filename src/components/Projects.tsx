...
const projects = [
  {
    ...
    stack: ['React.js', 'Supabase', 'WebSockets', 'TailwindCSS', 'Geolocation API'],
    status: 'Production',
  },
  {
    id: '02',
    ...
    icon: ShoppingCart,
    color: 'var(--green)',
    image: 'https://images.pexels.com/photos/1340504/pexels-photo-1340504.jpeg?auto=compress&cs=tinysrgb&w=800',
    description:
    ...
    stack: ['React.js', 'TailwindCSS', 'Redux Toolkit', 'Node.js', 'MongoDB', 'REST APIs'],
    status: 'Live',
  },
  {
    id: '03',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col gap-10">
          {projects.map((p, i) => (
            ...
            >
              <div className={`grid ${i % 2 === 0 ? 'lg:grid-cols-[55%_45%]' : 'lg:grid-cols-[45%_55%]'}`}>
                {/* Content */}
                <div className={`p-8 flex flex-col justify-center ${i % 2 !== 0 ? 'lg:order-2' : ''}`}>
                  ...
                  <p
                    className="mb-4"
                    style={{ fontFamily: 'var(--font-mono)', fontSize: '0.72rem', color: p.color, opacity: 0.75 }}
                  >
                    {p.subtitle}
                  </p>

                  {/* Description */}
                  <p className="mb-5" style={{ color: 'var(--text-dim)', fontSize: '0.88rem', lineHeight: '1.7' }}>
                    {p.description}
                  </p>
                  ...
                  <ul className="flex flex-col gap-2 mb-6">
                    {p.highlights.map((h, j) => (
                      <li key={j} className="flex gap-3" style={{ fontSize: '0.8rem', color: 'var(--text-dim)', lineHeight: '1.5' }}>
                  ...
                  <div className="flex gap-3">
                    <a href="https://github.com/nishchhal6" target="_blank" rel="noopener noreferrer" className="cyber-btn">
                      <Github size={13} />
                      Code
                    </a>
                    <a href="https://github.com/nishchhal6" target="_blank" rel="noopener noreferrer" className="cyber-btn">
