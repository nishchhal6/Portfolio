...
const techBadges = [
  ...
  'Node.js', 'Express.js', 'MongoDB', 'Supabase', 'MySQL',
  'TailwindCSS', 'Redux', 'WebSockets', 'REST APIs', 'Git',
  'GitHub', 'Postman', 'Django', 'Python', 'Figma',
];
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-1.5">
        ...
        <span style={{ fontFamily: 'var(--font-mono)', fontSize: '0.68rem', color: 'var(--cyan)', opacity: 0.7 }}>
          {level}%
        </span>
      </div>
  ...
  return (
    <section id="skills" className="relative py-28 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Badge cloud */}
        <div className={`fade-up ${visible ? 'visible' : ''}`} style={{ transitionDelay: '0.45s' }}>
          <div
